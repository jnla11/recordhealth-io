...
| 7 | api ADI | **Paused at step 2 (`6800ede`) until R2 ships; resumed under `ADI_GRADING_DESIGN_v1.3.md` §10's build order (v1.2 §2/§5/§6 superseded there), steps 1-4 shipped 2026-09-15 through 2026-09-17; build order replaced 2026-09-18 by `ADI_GRADING_DESIGN_v1.4.md` §10.** Console per ADI_GRADING_DESIGN §2/§5/§6: schema-driven gradeable classes, real-time entries (no lock-in), "Accept N shown", "Mark reviewed", reviewer progress; corrected package produced at lock; AI sections rendered from line ranges; relationships gradeable AND authorable (a reviewer draws a missing link between existing things: row to panel, atom to section, atom to address; owner ruling 2026-09-04, link authoring is integral to grading) | One real document graded end to end: reviewer progress shown throughout, a corrected package produced at lock | Opus 5 |
