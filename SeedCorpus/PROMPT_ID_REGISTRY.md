...
| pass1_atomization | v5 | core | recordhealth-api/src/pipeline-shared.mjs | Worker-side Atom Pass (server port of SegmentedAtomExtractionService). v4: kind/subtype vocabulary as prose, free-text JSON answer. v5 (2026-08-22, vocabulary v7 Phase 2): kind / subtype / date_role / classification_certainty / reliability wording generated from the dictionary snapshot; answer forced through the strict `emit_atoms` tool carrying the same enumerations (`src/extractor-vocabulary.mjs`). |
